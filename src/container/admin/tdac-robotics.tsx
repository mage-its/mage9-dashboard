...
interface TDACRoboticsProps {
    teamDoc: QueryDocumentSnapshot<DocumentData, DocumentData>
}

const TDACRobotics = (props: TDACRoboticsProps) => {
            ...
            <div className='grid gap-4 md:grid-cols-2'>
                <div className='bg-gray-800/70 rounded-xl p-4 h-min'>
                    ...
                    <div>
                        ...
                        {props.teamDoc.data().namaPembimbing &&
                            <div>
                                <h4 className='font-bold'>Nama Pembimbing</h4>
                                <p className='text-gray-300'> {props.teamDoc.data().namaPembimbing} </p>
                            </div>
                        }
                    ...
                    {props.teamDoc.data().waPembimbing && (
                        <>
                            <h4 className='mt-8'>Kontak Pembimbing</h4>
                            <hr className='my-2 border-white/50' />
                            ...
                            <div className='mt-4 grid grid-cols-2 gap-4'>
                                <div>
                                    <h4 className='font-bold'>Whatsapp</h4>
                                    <p className='text-gray-300'>
                                        <Link href={`https://wa.me/${props.teamDoc.data().waPembimbing.replace(/^0/, '62')}`} target='_blank' rel='noreferrer noopener'>
                                            {props.teamDoc.data().waPembimbing}
                                        </Link>
                                    </p>
                                </div>
